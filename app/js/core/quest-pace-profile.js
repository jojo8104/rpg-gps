const PROFILES = Object.freeze({
  calm: Object.freeze({
    royalCampMeters: 150,
    firstTraceMeters: 60,
    secondTraceMeters: 80,
    battlefieldMeters: 100,
    mineMeters: 120,
  }),
  sport: Object.freeze({
    royalCampMeters: 300,
    firstTraceMeters: 120,
    secondTraceMeters: 150,
    battlefieldMeters: 200,
    mineMeters: 220,
  }),
});
...
export function distanceForPace(values, paceMode, fallback) {
  ...
  if (!Number.isFinite(selected) || selected <= 0)
    throw new RangeError(
      "La distance de quête adaptée au rythme doit être positive.",
    );
  return selected;
}
