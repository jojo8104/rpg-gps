...
export class Player {
  constructor({ id, name, heroIds = [], discoveredLocationIds = [], locationKnowledge = {} }) {
  ...
  toJSON() { return { id: this.id, name: this.name, heroIds: [...this.heroIds], discoveredLocationIds: [...this.discoveredLocationIds], locationKnowledge: { ...this.locationKnowledge } }; }
