...
const heroClasses = [{ id: "fighter", name: "Combattant", abilityIds: [], startingUnits: [{ typeId: "runner", quantity: 10 }] }];
const definition = { id: "runner", maxQuantity: 10, stats: { attack: 1, defense: 1, ranged: 0, mobility: 1 } };
...
test("la fuite du héros laisse ses unités engagées sur le terrain", () => {
  ...
  assert.equal(fleeingUnit.quantity, 10);
